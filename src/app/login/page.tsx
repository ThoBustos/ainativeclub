...
function useClientUrls() {
  // Initialize with plain paths — matches server render, avoids hydration mismatch.
  // Updated after mount once window is available.
  ...
  useEffect(() => {
    ...
    setUrls({ isAppSubdomain: isApp, mainSiteUrl });
  }, []);
